...
SDL_DYNAPI_PROC(int,SDL_GetThreadPriority,(SDL_ThreadPriority *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_SetThreadPtrPriority,(SDL_Thread *a, SDL_ThreadPriority b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_GetThreadPtrPriority,(SDL_Thread *a, SDL_ThreadPriority *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_ThreadWrapper *,SDL_CreateThreadWrapper,(void),(),return)
SDL_DYNAPI_PROC(void,SDL_FreeThreadWrapper,(SDL_ThreadWrapper *a),(a),)
SDL_DYNAPI_PROC(SDL_Thread *,SDL_GetThread,(SDL_ThreadWrapper *a),(a),return)
